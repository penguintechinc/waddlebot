    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-navy-300 mt-2">Sign in to access your communities</p>
        </div>
            ...
            <>
              <div className="space-y-3">
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center space-x-3 px-4 py-3 bg-navy-800 border border-navy-600 rounded-lg hover:bg-navy-700 hover:border-sky-500 transition-all disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center space-x-3 px-4 py-3 bg-navy-800 border border-navy-600 rounded-lg hover:bg-navy-700 hover:border-purple-500 transition-all disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center space-x-3 px-4 py-3 bg-navy-800 border border-navy-600 rounded-lg hover:bg-navy-700 hover:border-emerald-500 transition-all disabled:opacity-50"
                >
