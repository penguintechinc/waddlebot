...
#!/bin/bash
#
# WaddleBot KICK Module - API Test Script
#
# Comprehensive test suite for the KICK receiver module API endpoints.
# Tests health checks, metrics, webhook handling, and module-specific APIs.
#
# Usage:
#   ./test-api.sh [OPTIONS]
#
...
print_color "$BOLD" "═══════════════════════════════════════════════════════════"
print_color "$BOLD" "       WaddleBot KICK Module - API Test Suite"
print_color "$BOLD" "═══════════════════════════════════════════════════════════"
echo ""
...
test_endpoint \
    ...
    "/health" \
    "200" \
    '.status == "healthy" and .module == "kick_module" and .version != null and .timestamp != null'
...
test_endpoint \
    ...
    "/healthz" \
    "200" \
    '.status != null and .module == "kick_module" and .version != null and .checks != null'
...
test_endpoint \
    ...
    "/metrics" \
    "200" \
    'contains("waddlebot_info") and contains("kick_module")'
...
test_endpoint \
    ...
    "/api/v1/status" \
    "200" \
    '.status == "operational" and .module == "kick_module"'
...
print_color "$BOLD" "┌─ Webhook Endpoints"
echo ""

# Note: Without proper signature, webhook should return 401 or accept
# This depends on whether KICK_WEBHOOK_SECRET is configured
test_endpoint \
    "POST /webhook/kick - Webhook endpoint exists" \
    "POST" \
    "/webhook/kick" \
    "401"
